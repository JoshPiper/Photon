...
Photon.AirEL.FormatName = function(id, unitString) return string.format("photon_airel_%s_%s.png", tostring(id), tostring(unitString)) end
...
Photon.AirEL.LoadMaterialFromFile = function(id, unitString) return Material(string.format("../data/photon/airel/photon_airel_%s_%s.png", id, unitString), "nocull smooth noclamp mips") end
